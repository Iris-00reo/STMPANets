...
def loaddataset(history_len, pred_len, mask_ratio,dataset, batch_size, val_ratio, test_ratio):
    ...
    train_x,train_y,masks_tra,masks_target_tra,val_x,val_y,masks_val,masks_target_val,test_x,test_y,masks_test,masks_target_test = split_data_by_ratio(x,y, mask,mask_target,val_ratio, test_ratio)
    ...
    test_dataloader = DataLoader(test_dataset,batch_size=batch_size, shuffle=False, num_workers=8, drop_last=True)
